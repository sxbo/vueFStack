<template>
    <div>
        ...
        <div class="share_code">
            ...
            <img src="../../images/4-4.png" height="212" width="212" alt="erweima" class="code_img">
        </div>
        <div class="share_cover" v-show="showHide" @click="showCover">
            <img src="../../images/5-2.png" alt="图片" class="share_img">
        </div>
    </div>
</template>
<script>
    ...
    methods: {
        computedScore() {
            this.answerid.forEach((item, index) => {
                if (item == this.rightAnwser[index]) {
                    this.score += 20;
                }
            });
        },
